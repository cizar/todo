...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("/home/sebasjm/Work/personal/userspace/todo/node_modules/react-hot-api/modules/index.js"), RootInstanceProvider = require("/home/sebasjm/Work/personal/userspace/todo/node_modules/react-hot-loader/RootInstanceProvider.js"), ReactMount = require("react/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
	...
	var _reactTapEventPlugin = __webpack_require__(1418);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactRedux = __webpack_require__(558);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.InputText = exports.Home = exports.Landing = exports.App = undefined;
	
	var _App2 = __webpack_require__(405);
	
	var _App3 = _interopRequireDefault(_App2);
	
	var _Landing2 = __webpack_require__(556);
	
	var _Landing3 = _interopRequireDefault(_Landing2);
	
	var _Home2 = __webpack_require__(588);
	
	var _Home3 = _interopRequireDefault(_Home2);
	
	var _InputText2 = __webpack_require__(760);
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'a',
	            { href: 'https://github.com/user-space/todo/zipball/master', className: 'btn' },
	            'Download as .zip'
	          ),
	          _react2.default.createElement(
	            'a',
	            { href: 'https://github.com/user-space/todo/tarball/master', className: 'btn' },
	            'Download as .tar.gz'
	          ),
	          _react2.default.createElement(
	            'a',
	            { href: 'https://github.com/user-space/todo', className: 'btn btn-github' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _connect = __webpack_require__(557);
	
	var _connect2 = _interopRequireDefault(_connect);
	
	var _user = __webpack_require__(586);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _namesGenerator = __webpack_require__(587);
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/sebasjm/Work/personal/userspace/todo/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "namesGenerator.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _todo = __webpack_require__(589);
	
	var todo = _interopRequireWildcard(_todo);
	
	var _userspace = __webpack_require__(590);
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	                ...
	                { className: 'left' },
	                'Items ',
	                _react2.default.createElement(_view.InputText, { onClick: actions.add, text: 'agregar', enabled: true })
	            ),
	            _react2.default.createElement(
	                'div',
	                { className: 'right' },
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    null,
	                    todos.map(function (sp, idx) {
	                        return _react2.default.createElement(
	                            'li',
	                            { key: sp.id },
	                            _react2.default.createElement(
	                                'span',
	                                { style: { textDecoration: sp.attributes.completed ? "line-through" : "inherit" } },
	                                ' ',
	                                sp.attributes.task,
	                                ' '
	                            ),
	                            _react2.default.createElement(
	                                'span',
	                                { style: { color: "red" }, onClick: function onClick(ev) {
	                                        return actions.complete(sp);
	                                    } },
	                                ' X '
	                            )
	                        );
	...
	}, { logout: _user.logout, list: todo.list, add: todo.add, complete: todo.complete })(HomeClass);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _parse = __webpack_require__(591);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _decode = __webpack_require__(593);
	
	var _decode2 = _interopRequireDefault(_decode);
	
	var _encode = __webpack_require__(708);
	
	var _encode2 = _interopRequireDefault(_encode);
	
	var _CoreManager = __webpack_require__(696);
	
	var _CoreManager2 = _interopRequireDefault(_CoreManager);
	
	var _InstallationController = __webpack_require__(739);
	
	var _InstallationController2 = _interopRequireDefault(_InstallationController);
	
	var _ParseOp = __webpack_require__(706);
	
	var ParseOp = _interopRequireWildcard(_ParseOp);
	
	var _RESTController = __webpack_require__(740);
	...
	Parse.ACL = __webpack_require__(662).default;
	Parse.Analytics = __webpack_require__(741);
	Parse.Cloud = __webpack_require__(742);
	Parse.CoreManager = __webpack_require__(696);
	Parse.Config = __webpack_require__(743).default;
	Parse.Error = __webpack_require__(689).default;
	Parse.FacebookUtils = __webpack_require__(744).default;
	Parse.File = __webpack_require__(698).default;
	Parse.GeoPoint = __webpack_require__(709).default;
	Parse.Installation = __webpack_require__(745).default;
	Parse.Object = __webpack_require__(690).default;
	Parse.Op = {
	  Set: ParseOp.SetOp,
	...
	Parse.Promise = __webpack_require__(699).default;
	Parse.Push = __webpack_require__(746);
	Parse.Query = __webpack_require__(711).default;
	Parse.Relation = __webpack_require__(705).default;
	Parse.Role = __webpack_require__(672).default;
	Parse.Session = __webpack_require__(736).default;
	Parse.Storage = __webpack_require__(737);
	Parse.User = __webpack_require__(734).default;
	Parse.LiveQuery = __webpack_require__(747).default;
	Parse.LiveQueryClient = __webpack_require__(750).default;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _typeof2 = __webpack_require__(594);
	
	var _typeof3 = _interopRequireDefault(_typeof2);
	
	exports.default = decode;
	
	var _ParseACL = __webpack_require__(662);
	
	var _ParseACL2 = _interopRequireDefault(_ParseACL);
	
	var _ParseFile = __webpack_require__(698);
	
	var _ParseFile2 = _interopRequireDefault(_ParseFile);
	
	var _ParseGeoPoint = __webpack_require__(709);
	
	var _ParseGeoPoint2 = _interopRequireDefault(_ParseGeoPoint);
	
	var _ParseObject = __webpack_require__(690);
	
	var _ParseObject2 = _interopRequireDefault(_ParseObject);
	
	var _ParseOp = __webpack_require__(706);
	
	var _ParseRelation = __webpack_require__(705);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _iterator = __webpack_require__(595);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(645).f('iterator');
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(601)(String, 'String', function(iterated){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toInteger = __webpack_require__(599)
	  , defined   = __webpack_require__(600);
	// true  -> String#at
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var LIBRARY        = __webpack_require__(602)
	  , $export        = __webpack_require__(603)
	  , redefine       = __webpack_require__(618)
	  , hide           = __webpack_require__(608)
	  , has            = __webpack_require__(619)
	  , Iterators      = __webpack_require__(620)
	  , $iterCreate    = __webpack_require__(621)
	  , setToStringTag = __webpack_require__(637)
	  , getPrototypeOf = __webpack_require__(639)
	  , ITERATOR       = __webpack_require__(638)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP         = __webpack_require__(609)
	  , createDesc = __webpack_require__(617);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject       = __webpack_require__(610)
	  , IE8_DOM_DEFINE = __webpack_require__(612)
	  , toPrimitive    = __webpack_require__(616)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(611)
	  , document = __webpack_require__(604).document
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var create         = __webpack_require__(622)
	  , descriptor     = __webpack_require__(617)
	  , setToStringTag = __webpack_require__(637)
	  , IteratorPrototype = {};
	
	// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
	__webpack_require__(608)(IteratorPrototype, __webpack_require__(638)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var anObject    = __webpack_require__(610)
	  , dPs         = __webpack_require__(623)
	  , enumBugKeys = __webpack_require__(635)
	  , IE_PROTO    = __webpack_require__(632)('IE_PROTO')
	...
	var createDict = function(){
	  ...
	  __webpack_require__(636).appendChild(iframe);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dP       = __webpack_require__(609)
	  , anObject = __webpack_require__(610)
	  , getKeys  = __webpack_require__(624);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has          = __webpack_require__(619)
	  , toIObject    = __webpack_require__(626)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cof = __webpack_require__(628);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// false -> Array#indexOf
	// true  -> Array#includes
	var toIObject = __webpack_require__(626)
	  , toLength  = __webpack_require__(630)
	  , toIndex   = __webpack_require__(631);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shared = __webpack_require__(633)('keys')
	  , uid    = __webpack_require__(634);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(604).document && document.documentElement;

/***/ },
/* 637 */
/***/ function(module, exports, __webpack_require__) {

	var def = __webpack_require__(609).f
	  , has = __webpack_require__(619)
	  , TAG = __webpack_require__(638)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store      = __webpack_require__(633)('wks')
	  , uid        = __webpack_require__(634)
	  , Symbol     = __webpack_require__(604).Symbol
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has         = __webpack_require__(619)
	  , toObject    = __webpack_require__(640)
	  , IE_PROTO    = __webpack_require__(632)('IE_PROTO')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var defined = __webpack_require__(600);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(604)
	  , hide          = __webpack_require__(608)
	  , Iterators     = __webpack_require__(620)
	  , TO_STRING_TAG = __webpack_require__(638)('toStringTag');
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(601)(Array, 'Array', function(iterated, kind){
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.f = __webpack_require__(638);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Symbol;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(604)
	  , has            = __webpack_require__(619)
	  , DESCRIPTORS    = __webpack_require__(613)
	  , $export        = __webpack_require__(603)
	  , redefine       = __webpack_require__(618)
	  , META           = __webpack_require__(649).KEY
	  , $fails         = __webpack_require__(614)
	  , shared         = __webpack_require__(633)
	  , setToStringTag = __webpack_require__(637)
	  , uid            = __webpack_require__(634)
	  , wks            = __webpack_require__(638)
	  , wksExt         = __webpack_require__(645)
	  , wksDefine      = __webpack_require__(650)
	  ...
	  , toPrimitive    = __webpack_require__(616)
	  , createDesc     = __webpack_require__(617)
	  , _create        = __webpack_require__(622)
	  , gOPNExt        = __webpack_require__(656)
	  , $GOPD          = __webpack_require__(658)
	  , $DP            = __webpack_require__(609)
	  , $keys          = __webpack_require__(624)
	  , gOPD           = $GOPD.f
	  , dP             = $DP.f
	  , gOPN           = gOPNExt.f
	...
	if(!USE_NATIVE){
	  ...
	  __webpack_require__(654).f  = $propertyIsEnumerable;
	  __webpack_require__(653).f = $getOwnPropertySymbols;
	
	  if(DESCRIPTORS && !__webpack_require__(602)){
	...
	$Symbol[PROTOTYPE][TO_PRIMITIVE] || __webpack_require__(608)($Symbol[PROTOTYPE], TO_PRIMITIVE, $Symbol[PROTOTYPE].valueOf);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var META     = __webpack_require__(634)('meta')
	  , isObject = __webpack_require__(611)
	  , has      = __webpack_require__(619)
	  , setDesc  = __webpack_require__(609).f
	  , id       = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(604)
	  , core           = __webpack_require__(605)
	  , LIBRARY        = __webpack_require__(602)
	  , wksExt         = __webpack_require__(645)
	  , defineProperty = __webpack_require__(609).f;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys   = __webpack_require__(624)
	  , toIObject = __webpack_require__(626);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var getKeys = __webpack_require__(624)
	  , gOPS    = __webpack_require__(653)
	  , pIE     = __webpack_require__(654);
	module.exports = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var toIObject = __webpack_require__(626)
	  , gOPN      = __webpack_require__(657).f
	  , toString  = {}.toString;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $keys      = __webpack_require__(625)
	  , hiddenKeys = __webpack_require__(635).concat('length', 'prototype');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var pIE            = __webpack_require__(654)
	  , createDesc     = __webpack_require__(617)
	  , toIObject      = __webpack_require__(626)
	  , toPrimitive    = __webpack_require__(616)
	  , has            = __webpack_require__(619)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _keys = __webpack_require__(663);
	...
	var _classCallCheck2 = __webpack_require__(667);
	
	var _classCallCheck3 = _interopRequireDefault(_classCallCheck2);
	
	var _createClass2 = __webpack_require__(668);
	
	var _createClass3 = _interopRequireDefault(_createClass2);
	
	var _ParseRole = __webpack_require__(672);
	
	var _ParseRole2 = _interopRequireDefault(_ParseRole);
	
	var _ParseUser = __webpack_require__(734);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Object.keys;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(666)('keys', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _defineProperty = __webpack_require__(669);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $Object = __webpack_require__(605).Object;
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(613), 'Object', {defineProperty: __webpack_require__(609).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getPrototypeOf = __webpack_require__(673);
	...
	var _possibleConstructorReturn2 = __webpack_require__(676);
	
	var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);
	
	var _get2 = __webpack_require__(677);
	
	var _get3 = _interopRequireDefault(_get2);
	
	var _inherits2 = __webpack_require__(681);
	...
	var _ParseError = __webpack_require__(689);
	
	var _ParseError2 = _interopRequireDefault(_ParseError);
	
	var _ParseObject2 = __webpack_require__(690);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Object.getPrototypeOf;
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(666)('getPrototypeOf', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getOwnPropertyDescriptor = __webpack_require__(678);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
	var toIObject                 = __webpack_require__(626)
	  , $getOwnPropertyDescriptor = __webpack_require__(658).f;
	
	__webpack_require__(666)('getOwnPropertyDescriptor', function(){
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Object.setPrototypeOf;
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(606)(Function.call, __webpack_require__(658).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $export = __webpack_require__(603)
	// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
	$export($export.S, 'Object', {create: __webpack_require__(622)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _freeze = __webpack_require__(691);
	...
	var _canBeSerialized = __webpack_require__(697);
	...
	var _equals = __webpack_require__(712);
	
	var _equals2 = _interopRequireDefault(_equals);
	
	var _escape2 = __webpack_require__(713);
	...
	var _parseDate = __webpack_require__(714);
	...
	var _ParsePromise = __webpack_require__(699);
	
	var _ParsePromise2 = _interopRequireDefault(_ParsePromise);
	
	var _ParseQuery = __webpack_require__(711);
	...
	var _SingleInstanceStateController = __webpack_require__(715);
	
	var SingleInstanceStateController = _interopRequireWildcard(_SingleInstanceStateController);
	
	var _unique = __webpack_require__(710);
	
	var _unique2 = _interopRequireDefault(_unique);
	
	var _UniqueInstanceStateController = __webpack_require__(718);
	
	var UniqueInstanceStateController = _interopRequireWildcard(_UniqueInstanceStateController);
	
	var _unsavedChildren = __webpack_require__(733);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Object.freeze;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(611)
	  , meta     = __webpack_require__(649).onFreeze;
	
	__webpack_require__(666)('freeze', function($freeze){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var core  = __webpack_require__(605)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getIterator2 = __webpack_require__(700);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).getIterator = function(it){
	  var iterFn = get(it);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classof   = __webpack_require__(704)
	  , ITERATOR  = __webpack_require__(638)('iterator')
	  , Iterators = __webpack_require__(620);
	module.exports = __webpack_require__(605).getIteratorMethod = function(it){
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _arrayContainsObject = __webpack_require__(707);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ObjectStateMutations = __webpack_require__(716);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _TaskQueue = __webpack_require__(717);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _weakMap = __webpack_require__(719);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).WeakMap;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $WeakMap = module.exports = __webpack_require__(732)('WeakMap', wrapper, methods, weak, true, true);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// 5 -> Array#find
	// 6 -> Array#findIndex
	var ctx      = __webpack_require__(606)
	  , IObject  = __webpack_require__(627)
	  , toObject = __webpack_require__(640)
	  , toLength = __webpack_require__(630)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isObject = __webpack_require__(611)
	  , isArray  = __webpack_require__(655)
	  , SPECIES  = __webpack_require__(638)('species');
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var redefineAll       = __webpack_require__(727)
	  , getWeak           = __webpack_require__(649).getWeak
	  , anObject          = __webpack_require__(610)
	  , isObject          = __webpack_require__(611)
	  , anInstance        = __webpack_require__(728)
	  , forOf             = __webpack_require__(729)
	  , createArrayMethod = __webpack_require__(722)
	  , $has              = __webpack_require__(619)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ctx         = __webpack_require__(606)
	  , call        = __webpack_require__(730)
	  , isArrayIter = __webpack_require__(731)
	  , anObject    = __webpack_require__(610)
	  , toLength    = __webpack_require__(630)
	  , getIterFn   = __webpack_require__(703)
	  , BREAK       = {}
	  , RETURN      = {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Iterators  = __webpack_require__(620)
	  , ITERATOR   = __webpack_require__(638)('iterator')
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global         = __webpack_require__(604)
	  ...
	  , fails          = __webpack_require__(614)
	  , hide           = __webpack_require__(608)
	  , redefineAll    = __webpack_require__(727)
	  , forOf          = __webpack_require__(729)
	  , anInstance     = __webpack_require__(728)
	  , isObject       = __webpack_require__(611)
	  , setToStringTag = __webpack_require__(637)
	  , dP             = __webpack_require__(609).f
	  , each           = __webpack_require__(722)(0)
	  , DESCRIPTORS    = __webpack_require__(613);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isRevocableSession = __webpack_require__(735);
	...
	var _ParseSession = __webpack_require__(736);
	
	var _ParseSession2 = _interopRequireDefault(_ParseSession);
	
	var _Storage = __webpack_require__(737);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_CoreManager2.default.setStorageController(__webpack_require__(738));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventEmitter = __webpack_require__(748);
	
	var _EventEmitter2 = _interopRequireDefault(_EventEmitter);
	
	var _LiveQueryClient = __webpack_require__(750);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(749).EventEmitter;
	var EventEmitter;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _map = __webpack_require__(751);
	...
	var _EventEmitter2 = __webpack_require__(748);
	...
	var _LiveQuerySubscription = __webpack_require__(759);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(605).Map;
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var strong = __webpack_require__(754);
	
	// 23.1 Map Objects
	module.exports = __webpack_require__(732)('Map', function(get){
...
/***/ function(module, exports, __webpack_require__) {
	...
	'use strict';
	var dP          = __webpack_require__(609).f
	  , create      = __webpack_require__(622)
	  , redefineAll = __webpack_require__(727)
	  , ctx         = __webpack_require__(606)
	  , anInstance  = __webpack_require__(728)
	  , defined     = __webpack_require__(600)
	  , forOf       = __webpack_require__(729)
	  , $iterDefine = __webpack_require__(601)
	  , step        = __webpack_require__(644)
	  , setSpecies  = __webpack_require__(755)
	  , DESCRIPTORS = __webpack_require__(613)
	  , fastKey     = __webpack_require__(649).fastKey
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P + $export.R, 'Map', {toJSON: __webpack_require__(757)('Map')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forOf = __webpack_require__(729);
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    _createClass(InputText, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { onChange: this.onChange, disabled: !this.props.enabled, ref: function ref(input) {
	                        return _this2.textInput = input;
	                    } }),
	                _react2.default.createElement(
	                    'a',
	                    { style: this.props.enabled ? undefined : { color: 'red' },
	...
	/* REACT HOT LOADER */ }).call(this); } finally { if (false) { (function () { var foundReactClasses = module.hot.data && module.hot.data.foundReactClasses || false; if (module.exports && module.makeHot) { var makeExportsHot = require("/home/sebasjm/Work/personal/userspace/todo/node_modules/react-hot-loader/makeExportsHot.js"); if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "InputText.js" + ": " + err.message); } }); } } module.hot.dispose(function (data) { data.makeHot = module.makeHot; data.foundReactClasses = foundReactClasses; }); })(); } }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxLogger = __webpack_require__(762);
	
	var _reduxLogger2 = _interopRequireDefault(_reduxLogger);
	
	var _reduxObservable = __webpack_require__(768);
	
	var _configureStore = __webpack_require__(813);
	
	var _configureStore2 = _interopRequireDefault(_configureStore);
	
	var _model = __webpack_require__(814);
	
	var _model2 = _interopRequireDefault(_model);
	
	var _controller = __webpack_require__(1113);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _core = __webpack_require__(763);
	
	var _helpers = __webpack_require__(764);
	
	var _defaults = __webpack_require__(767);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _diff = __webpack_require__(765);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _deepDiff = __webpack_require__(766);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _createEpicMiddleware = __webpack_require__(769);
	...
	var _ActionsObservable = __webpack_require__(794);
	...
	var _combineEpics = __webpack_require__(809);
	...
	var _EPIC_END = __webpack_require__(808);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Subject = __webpack_require__(770);
	
	var _map = __webpack_require__(787);
	
	var _switchMap = __webpack_require__(788);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Observable2 = __webpack_require__(771);
	
	var _of2 = __webpack_require__(795);
	
	var _from2 = __webpack_require__(800);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _merge = __webpack_require__(810);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todo = exports.user = undefined;
	...
	var _todo = __webpack_require__(1112);
	...
	exports.default = (0, _redux.combineReducers)({
	  user: _user2.default, todo: _todo2.default,
	  //  form: formReducer,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _event = __webpack_require__(816);
	
	var _auth = __webpack_require__(817);
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case _event.user.LOGIN:
	            return _extends({}, state, {
	                token: state.token.clear()
	            });
	        case _event.user.LOGOUT:
	            return _extends({}, state, {
	                profile: ANON_USER,
	                token: state.token.clear()
	            });
	        case _event.user.LOGIN_OK:
	            return _extends({}, state, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _auth0Lock = __webpack_require__(818);
	
	var _auth0Lock2 = _interopRequireDefault(_auth0Lock);
	
	var _config = __webpack_require__(1108);
	
	var _jwtDecode = __webpack_require__(1109);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var auth0 = exports.auth0 = {
	    client: 'gXXOhNU2eabogesxaq0fYIWcS3fLUPIl',
	    domain: 'userspace.auth0.com'
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var base64_url_decode = __webpack_require__(1110);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var atob = __webpack_require__(1111);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	    ...
	    switch (action.type) {
	        case _event.user.LOGOUT:
	        case _event.todo.LIST_FAIL:
	            return _extends({}, state, {
	                list: []
	            });
	        case _event.todo.LIST_OK:
	            return _extends({}, state, {
	                list: action.payload
	            });
	        default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.todo = exports.location = exports.user = undefined;
	...
	var _location = __webpack_require__(1416);
	
	var _location2 = _interopRequireDefault(_location);
	
	var _todo = __webpack_require__(1417);
	...
	exports.todo = _todo2.default;
	exports.default = (0, _reduxObservable.combineEpics)(_user2.default, _location2.default, _todo2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rxjs = __webpack_require__(1115);
	...
	exports.default = function (action$) {
	  return _rxjs.Observable.merge(action$.ofType(_event.user.LOGOUT).do(function (action) {
	    return auth.logout();
	  }).ignoreElements(), action$.ofType(_event.user.LOGIN).flatMap(function (action) {
	    return auth.login();
	  }).map(function (result) {
	    return {
	      type: _event.user.LOGIN_OK,
	      payload: result
	    };
	  }).catch(function (error) {
	    return _rxjs.Observable.of({
	      type: _event.user.LOGIN_FAIL,
	...
	exports.default = function (action$, store) {
	  var _action$$ofType$parti = action$.ofType('@@router/LOCATION_CHANGE').partition(function (action) {
	    return secured.indexOf(action.payload.pathname) !== -1 && !store.getState().user.token.isLoggedIn();
	      ...
	      _action$$ofType$parti2 = _slicedToArray(_action$$ofType$parti, 2),
	      unauth = _action$$ofType$parti2[0],
	      auth = _action$$ofType$parti2[1];
	
	  return _rxjs.Observable.merge(action$.ofType(_event.user.LOGIN_OK).map(function (action) {
	    return (0, _reactRouterRedux.replace)('/home');
	  }), action$.ofType(_event.user.LOGOUT).map(function (action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function (action$) {
	    return _rxjs.Observable.merge(action$.ofType(_event.todo.LIST).flatMap(function (action) {
	        return query.limit(10).addDescending("createdAt").find();
	    }).map(function (result) {
	        return {
	            type: _event.todo.LIST_OK,
	            payload: result
	        };
	    }).catch(function (error) {
	        return _rxjs.Observable.of({
	            type: _event.todo.LIST_FAIL,
	            payload: error.xhr.response,
	            error: true
	        });
	    }), action$.ofType(_event.todo.ADD).flatMap(function (action) {
	        return new ToDo().save({ task: action.payload, completed: false });
	    }).map(function (response) {
	        return {
	            type: _event.todo.LIST
	        };
	    }), action$.ofType(_event.todo.COMPLETE).map(function (action) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var invariant = __webpack_require__(1419);
	var defaultClickRejectionStrategy = __webpack_require__(1420);
	...
	should be injected by the application.'
	  ...
	  __webpack_require__(877).injection.injectEventPluginsByName({
	    'TapEventPlugin':       __webpack_require__(1421)(shouldRejectClick)
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventConstants = __webpack_require__(875);
	var EventPluginUtils = __webpack_require__(879);
	var EventPropagators = __webpack_require__(876);
	var SyntheticUIEvent = __webpack_require__(910);
	var TouchEventUtils = __webpack_require__(1422);
	var ViewportMetrics = __webpack_require__(911);
	
	var keyOf = __webpack_require__(1423);
